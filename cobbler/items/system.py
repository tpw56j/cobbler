...
class System(Item):
    ...
    def profile(self, profile_name: str):
        ...
        if profile_name in ["delete", "None", "~", ""]:
            self._profile = ""
            if self._has_initialized and "" != old_profile and self._inmemory:
        ...
        if self._has_initialized and profile_name != old_profile and self._inmemory:
    ...
    def image(self, image_name: str):
        ...
        if image_name in ["delete", "None", "~", ""]:
            self._image = ""
            if self._has_initialized and "" != old_image and self._inmemory:
        ...
        if self._has_initialized and image_name != old_image and self._inmemory:
